    ...
    list: [
      {
        ...
        type: 'text',
        char_count: 13,
        parent_title: '"有为政府"如何促进中国产业政策演进',
        parent_title_id: 'title::URbXKJ::0',
        enabled: true,
        source: 'Auto',
        is_edit: false
      },
      {
        ...
        type: 'text',
        char_count: 628,
        parent_title: '$\\bigcirc$ 张睿涵，王石玉²',
        parent_title_id: 'title::DEM3sb::2',
        enabled: true,
        source: 'Auto',
        is_edit: false
      },
      {
        ...
        char_count: 2017,
        parent_title: '1 问题提出',
        parent_title_id: 'title::rgKNIY::8',
        enabled: true,
        source: 'Auto',
        is_edit: false
      },
      ...
      },
      {
        ...
        type: 'text',
        char_count: 1423,
        parent_title: '2 中国移动通信产业政策节奏分析',
        parent_title_id: 'title::CBuSHP::17',
        enabled: true,
        source: 'Auto',
        is_edit: false
      },
      {
        ...
        type: 'text',
        char_count: 450,
        parent_title: '3 结论与展望',
        parent_title_id: 'title::FINAL::25',
        enabled: true,
        source: 'Auto',
        is_edit: false
      }
