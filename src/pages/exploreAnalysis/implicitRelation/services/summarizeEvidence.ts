...
const ALGORITHM_GUIDE: Record<ImplicitDiscoveryAlgorithm, string> = {
  ...
  'core-node':
    '核心节点：依据度中心性与介数中心性识别网络枢纽，若核心节点与周边实例尚未直连但结构可达，则可能存在应补建的关键关联。',
  'weak-link':
    '薄弱环节：关注跨群体桥接过少的结构区间，若不同群体成员之间缺少直连且桥接稀疏，补建隐性连边有助于加固整体网络。'
};
...
2. 必须点明本次算法（社区分析 / 路径预测 / 时空分析 / 核心节点 / 薄弱环节）在图谱上具体说明了什么，并结合证据中的事实
