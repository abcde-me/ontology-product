import type { CredentialFormSchemaBase } from '@/pages/workflowConfig/models/model'
import type { ToolCredential } from '@/pages/workflowConfig/tools/types'
import type { Locale } from '@/pages/workflowConfig/i18n'
