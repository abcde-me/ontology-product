...
const LimitTips = () => {
  ...
  return (
    <div className='app-workflow-page-limit-tips absolute bottom-16 left-1/2 -translate-x-1/2 flex items-center rounded-xl p-2 h-10 border border-components-panel-border bg-components-panel-bg-blur shadow-md z-[9]'>
      <div
