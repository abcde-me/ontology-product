...
// import { PluginType } from '@/pages/workflowConfig/plugins/types'
...
const AllTools = ({
  ...
  return (
    <div className={cn(className)}>
      <div className='flex items-center justify-between px-3 bg-background-default-hover border-b-[0.5px] border-divider-subtle shadow-xs'>
        <div className='flex items-center h-8 space-x-1'>
          {
            tabs.map(tab => (
              <div
                className={cn(
                  'flex items-center px-2 h-6 rounded-[4px] hover:bg-state-base-hover cursor-pointer',
        ...
        {supportAddCustomTool && (
          <div className='flex items-center'>
            ...
            <ActionButton
              className='rounded-[4px] bg-components-button-primary-bg hover:bg-components-button-primary-bg text-components-button-primary-text hover:text-components-button-primary-text'
      ...
      <div
        ref={wrapElemRef}
        className='max-h-[464px] overflow-y-auto tools-nodes-list'
