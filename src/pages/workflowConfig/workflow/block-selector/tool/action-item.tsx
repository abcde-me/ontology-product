...
import type { Tool } from '@/pages/workflowConfig/tools/types'
...
const ToolItem: FC<Props> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className={cn('h-8 leading-8 border-l-2 border-divider-subtle pl-4 truncate text-text-secondary system-sm-medium font-semibold', disabled && 'opacity-30')}>{payload.label[language]}</div>
        {disabled && <Badge
