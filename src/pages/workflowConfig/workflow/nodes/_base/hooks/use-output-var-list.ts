...
import type { ValueSelector } from '@/pages/workflowConfig/workflow/types';
import { BlockEnum, VarType } from '@/pages/workflowConfig/workflow/types';
import { useWorkflow } from '@/pages/workflowConfig/workflow/hooks';
import { ErrorHandleTypeEnum } from '@/pages/workflowConfig/workflow/nodes/_base/components/error-handle/types';
import { getDefaultValue } from '@/pages/workflowConfig/workflow/nodes/_base/components/error-handle/utils';
    ...
    (newVars: OutputVar, changedIndex?: number, newKey?: string) => {
      const newInputs = produce(inputs, (draft: any) => {
        ...
        if (
          ...
          (inputs as CodeNodeType).error_strategy ===
            ErrorHandleTypeEnum.defaultValue &&
          varKey === 'outputs'
        )
