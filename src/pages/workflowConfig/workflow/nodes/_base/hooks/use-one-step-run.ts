...
import { getNodeInfoById, isConversationVar, isENV, isSystemVar, toNodeOutputVars } from '@/pages/workflowConfig/workflow/nodes/_base/components/variable/utils'

import type { CommonNodeType, InputVar, ValueSelector, Var, Variable } from '@/pages/workflowConfig/workflow/types'
import { BlockEnum, InputVarType, NodeRunningStatus, VarType } from '@/pages/workflowConfig/workflow/types'
import { useStore as useAppStore } from '@/pages/workflowConfig/app/store'
import { useStore, useWorkflowStore } from '@/pages/workflowConfig/workflow/store'
...
import LLMDefault from '@/pages/workflowConfig/workflow/nodes/llm/default'
import KnowledgeRetrievalDefault from '@/pages/workflowConfig/workflow/nodes/knowledge-retrieval/default'
import IfElseDefault from '@/pages/workflowConfig/workflow/nodes/if-else/default'
import CodeDefault from '@/pages/workflowConfig/workflow/nodes/code/default'
// import TemplateTransformDefault from '@/pages/workflowConfig/workflow/nodes/template-transform/default'
import QuestionClassifyDefault from '@/pages/workflowConfig/workflow/nodes/question-classifier/default'
import HTTPDefault from '@/pages/workflowConfig/workflow/nodes/http/default'
import ToolDefault from '@/pages/workflowConfig/workflow/nodes/tool/default'
import VariableAssigner from '@/pages/workflowConfig/workflow/nodes/variable-assigner/default'
import Assigner from '@/pages/workflowConfig/workflow/nodes/assigner/default'
import ParameterExtractorDefault from '@/pages/workflowConfig/workflow/nodes/parameter-extractor/default'
import IterationDefault from '@/pages/workflowConfig/workflow/nodes/iteration/default'
import DocumentExtractorDefault from '@/pages/workflowConfig/workflow/nodes/document-extractor/default'
import LoopDefault from '@/pages/workflowConfig/workflow/nodes/loop/default'
// import { ssePost } from '@/service/base'

import { getInputVars as doGetInputVars } from '@/pages/workflowConfig/components/prompt-editor/constants'
  ...
  const handleRun = async (submitData: Record<string, any>) => {
    ...
    try {
      if (!isIteration && !isLoop) {
        console.warn('API NOT IMPLEMENTED', 'ssePost', 'singleNodeRun')
        ...
        console.warn('API NOT IMPLEMENTED', 'ssePost', 'getIterationSingleNodeRunUrl')
        const ssePost = (...args: any) => {}
        const getIterationSingleNodeRunUrl = (...args: any) => { return ''}
        ssePost(
        ...
        console.warn('API NOT IMPLEMENTED', 'ssePost', 'getLoopSingleNodeRunUrl')
        const ssePost = (...args: any) => {}
        const getLoopSingleNodeRunUrl = (...args: any) => { return ''}
        ssePost(
