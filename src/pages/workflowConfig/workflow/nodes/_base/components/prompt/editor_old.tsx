...
const Editor: FC<Props> = ({
  ...
  return (
    <Wrap className={cn(className, wrapClassName)} style={wrapStyle} isInNode isExpand={isExpand}>
      <div ref={ref} className={cn(isFocus ? (gradientBorder && s.gradientBorder) : 'bg-gray-100', isExpand && 'h-full', '!rounded-[4px] p-0.5', containerClassName)}>
        <div className={cn(isFocus ? 'bg-gray-50' : 'bg-gray-100', isExpand && 'h-full flex flex-col', 'rounded-[4px]', containerClassName)}>
            ...
            <div className='flex items-center'>
              ...
              <div className='flex items-center space-x-[2px]'>
                ...
                {!isCopied
                  ...
                  : (
                    <ActionButton>
                      <RiClipboardFill className='w-4 h-4' />
                    </ActionButton>
                  )
                }
