import type { CredentialFormSchemaNumberInput, CredentialFormSchemaTextInput } from '@/pages/workflowConfig/models/model'
import { type CredentialFormSchema, FormTypeEnum, ModelTypeEnum } from '@/pages/workflowConfig/models/model'
import type { ToolVarInputs } from '../../tool/types'
import ListEmpty from '@/pages/workflowConfig/components/list-empty'
import { AgentStrategySelector } from './agent-strategy-selector'
import { useTranslation } from 'react-i18next'
// import Form from '@/app/components/header/account-setting/model-provider-page/model-modal/Form'
import { RiRobot2Line } from '@remixicon/react'
import { InputNumber } from '@/pages/workflowConfig/components/input-number'
import Slider from '@/pages/workflowConfig/components/slider'
// import ToolSelector from '@/app/components/plugins/plugin-detail-panel/tool-selector'
// import MultipleToolSelector from '@/app/components/plugins/plugin-detail-panel/multiple-tool-selector'
import Field from './field'
import React, { type ComponentProps, memo } from 'react'
import { useDefaultModel } from '@/pages/workflowConfig/hooks/use-model'
import Editor from './prompt/editor'
import { useWorkflowStore } from '../../../store'
import { useRenderI18nObject } from '@/pages/workflowConfig/hooks/use-i18n'
...
export const AgentStrategy = memo((props: AgentStrategyProps) => {
  ...
  const override: ComponentProps<any>['override'] = [
  ...
  const renderField: ComponentProps<any>['customRenderField'] = (schema, props) => {
    switch (schema.type) {
  ...
  return <div className='space-y-2'>
    <AgentStrategySelector value={strategy} onChange={onStrategyChange} />
    {
      strategy
        ...
        : <ListEmpty
          icon={<RiRobot2Line className='w-5 h-5 shrink-0 text-text-accent' />}
          ...
          description={<div className='text-text-tertiary text-xs'>
            ...
            <a href={'/'} className='text-text-accent-secondary'>
