...
// Temporary Field component replacement
const Field = ({
  title,
  className,
  children
...
import { useFileSizeLimit } from '@/pages/workflowConfig/components/file-uploader/hooks';
import { formatFileSize } from '@/pages/workflowConfig/utils/format';
import fileUploadConfig from '@/pages/workflowConfig/mockData/fileUploadConfig.json';
...
const FileUploadSetting: FC<Props> = ({
  ...
  // console.warn('API NOT IMPLEMENTED', 'fetchFileUploadConfig')
  const fileUploadConfigResponse = fileUploadConfig;
  const {
    imgSizeLimit,
    docSizeLimit,
    audioSizeLimit,
        ...
        <Field title={t('appDebug.variableConfig.file.supportFileTypes')}>
          <div className="space-y-1">
            ...
            <FileTypeItem
              ...
              selected={allowed_file_types.includes(
