    ...
    <>
      <Handle
        ...
        className={cn(
          ...
          'before:absolute before:w-[0.6875rem] before:h-[0.6875rem] before:rounded-full before:right-[0.26rem] before:top-[0.15rem] before:bg-[white]',
          'after:absolute after:w-2 after:h-2 after:rounded-full after:right-1.5 after:top-1 after:bg-workflow-link-line-handle z-[2]',
          ...
          !connected && 'after:opacity-0 before:opacity-0',
...
export const NodeSourceHandle = memo(({
  ...
  return (
    <Handle
      ...
      onClick={handleHandleClick}
    >
      <div className='hidden group-hover/handle:block absolute left-1/2 -top-1 -translate-y-full -translate-x-1/2 p-1.5 border-[0.5px] border-components-panel-border bg-components-tooltip-bg rounded-[4px] shadow-lg'>
        <div className='system-xs-regular text-text-tertiary'>
          <div className=' whitespace-nowrap mb-[8px]'>
