...
const OptionCard: FC<Props> = ({
  ...
  return (
    <div
      className={cn(
        'flex items-center px-2 h-8 rounded-[4px] system-sm-regular bg-components-option-card-option-bg border border-components-option-card-option-border text-text-secondary cursor-default',
