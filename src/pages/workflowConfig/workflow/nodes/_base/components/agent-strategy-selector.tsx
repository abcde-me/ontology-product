import { PortalToFollowElem, PortalToFollowElemContent, PortalToFollowElemTrigger } from '@/pages/workflowConfig/components/portal-to-follow-elem'
...
import SearchInput from '@/pages/workflowConfig/components/search-input'
import Tools from '../../../block-selector/tools'
import { useTranslation } from 'react-i18next'
// import { useStrategyProviders } from '@/service/use-strategy'
import { PluginType, type StrategyPluginDetail } from '@/pages/workflowConfig/plugins/types'
import type { ToolWithProvider } from '../../../types'
import { CollectionType } from '@/pages/workflowConfig/tools/types'
// import useGetIcon from '@/pages/workflowConfig/plugins/install-plugin/base/use-get-icon'
// import { useStrategyInfo } from '../../agent/use-config'
import { SwitchPluginVersion } from './switch-plugin-version'
// import PluginList from '@/pages/workflowConfig/workflow/block-selector/market-place-plugin/list'
// import { useMarketplacePlugins } from '@/app/components/plugins/marketplace/hooks'
import { ToolTipContent } from '@/pages/workflowConfig/components/tooltip/content'
  ...
  return <Tooltip
    popupContent={
      <div className='space-y-1 text-xs'>
        ...
        <p>
          <a href={'/plugins'} className='text-text-accent tracking-tight'>
...
export const AgentStrategySelector = memo((props: AgentStrategySelectorProps) => {
  ...
  // )
  const { strategyStatus, refetch: refetchStrategyInfo } = {} as any
