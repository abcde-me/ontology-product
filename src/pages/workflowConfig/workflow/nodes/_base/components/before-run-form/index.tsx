...
import { InputVarType, NodeRunningStatus } from '@/pages/workflowConfig/workflow/types'
...
import type { Emoji } from '@/pages/workflowConfig/tools/types'
import type { SpecialResultPanelProps } from '@/pages/workflowConfig/workflow/run/special-result-panel'
import SpecialResultPanel from '@/pages/workflowConfig/workflow/run/special-result-panel'
...
const BeforeRunForm: FC<BeforeRunFormProps> = ({
  ...
  return (
    <div className='absolute inset-0 z-10 rounded-[4px] pt-10' style={{
      backgroundColor: 'rgba(16, 24, 40, 0.20)',
    }}>
      <div className='h-full rounded-[4px] bg-white flex flex-col'>
              ...
              <div className='mt-4 flex justify-between space-x-2 px-4' >
                {isRunning && (
                  <div
                    ...
                    onClick={onStop}
                  >
                    <RiStopCircleLine className='w-4 h-4 text-gray-500' />
                  </div>
                )}
                <Button disabled={!isFileLoaded || isRunning} variant='primary' className='custom-primary w-0 grow space-x-2' onClick={handleRun}>
