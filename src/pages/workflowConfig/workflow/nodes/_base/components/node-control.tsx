...
const NodeControl: FC<NodeControlProps> = ({
  ...
  return (
    ...
    >
      <div
        className='flex items-center px-0.5 h-6 bg-components-actionbar-bg rounded-[6px] border-[0.5px] border-components-actionbar-border backdrop-blur-[5px] shadow-md text-text-tertiary'
