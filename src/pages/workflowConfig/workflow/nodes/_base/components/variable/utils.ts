...
import { BlockEnum, InputVarType, VarType } from '@/pages/workflowConfig/workflow/types'
import type { StartNodeType } from '@/pages/workflowConfig/workflow/nodes/start/types'
import type { ConversationVariable, EnvironmentVariable, Node, NodeOutPutVar, ValueSelector, Var } from '@/pages/workflowConfig/workflow/types'
import type { VariableAssignerNodeType } from '@/pages/workflowConfig/workflow/nodes/variable-assigner/types'
import {
  ...
  TOOL_OUTPUT_STRUCT,
} from '@/pages/workflowConfig/workflow/constants'
import type { PromptItem } from '@/pages/workflowConfig/models/debug'
import { VAR_REGEX } from '@/pages/workflowConfig/config/'
// import type { AgentNodeType } from '../../../agent/types'

type AgentNodeType = any
type TemplateTransformNodeType = any
...
const inputVarTypeToVarType = (type: InputVarType): VarType => {
  return ({
    ...
    [InputVarType.integer]: VarType.integer,
    [InputVarType.array]: VarType.array,
