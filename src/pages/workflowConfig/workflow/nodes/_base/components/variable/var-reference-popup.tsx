...
import type { NodeOutPutVar, ValueSelector, Var } from '@/pages/workflowConfig/workflow/types'
...
const VarReferencePopup: FC<Props> = ({
  ...
  return (
    <div className='p-1 bg-white rounded-[4px] border border-gray-200 shadow-lg space-y-1' style={{
      width: itemWidth || 228,
    }}>
