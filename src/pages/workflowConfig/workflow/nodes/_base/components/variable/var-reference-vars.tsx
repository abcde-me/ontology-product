...
import { type NodeOutPutVar, type ValueSelector, type Var, VarType } from '@/pages/workflowConfig/workflow/types'
...
import { FILE_STRUCT } from '@/pages/workflowConfig/workflow/constants'
      ...
      <PortalToFollowElemTrigger className='w-full'>
        <div
          ...
          className={cn(
            ...
            'relative w-full flex items-center h-6 pl-3  rounded-[4px] cursor-pointer')
          }
        ...
        >
          ...
          {isObj && (
            <RiArrowRightSLine className={cn('ml-0.5 w-3 h-3 text-text-quaternary', isHovering && 'text-text-tertiary')} />
          )}
        </div>
      </PortalToFollowElemTrigger>
...
const ObjectChildren: FC<ObjectChildrenProps> = ({
  ...
  // absolute top-[-2px]
  return (
    <div ref={itemRef} className=' bg-white rounded-[4px] border border-gray-200 shadow-lg space-y-1' style={{
