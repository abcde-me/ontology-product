...
const VarReferencePicker: FC<Props> = ({
  ...
  const [maxNodeNameWidth, maxVarNameWidth, maxTypeWidth] = (() => {
    ...
    const maxNodeNameWidth =
      PRIORITY_WIDTH +
      Math.floor(
        ((outputVarNode?.title?.length || 0) / totalTextLength) * availableWidth
      );
    ...
    <div className={cn(className, !readonly && 'cursor-pointer')}>
      ...
      >
        <WrapElem
          ...
          className="group/picker-trigger-wrap var-reference-picker-wrapper relative !flex"
        >
          <>
            {isAddBtnTrigger ? (
              <div>
              ...
              <div
                ...
                className={cn(
                  ...
                  !isSupportConstantValue &&
                    'rounded-[4px] bg-components-input-bg-normal p-[6px] px-[8px]',
              ...
              >
                {isSupportConstantValue ? (
                  ...
                  !hasValue && (
                    <div className="ml-1.5 mr-1 hidden">
                      <RiBracesLine
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div
                          className={cn(
                            'h-full items-center rounded-[4px] px-[8px]',
                            hasValue
                              ? 'inline-flex border-[1px] border-[#CBD5E1] bg-white'
                              : 'flex'
                          )}
                        >
                          {hasValue ? (
                            <>
                              {isShowNodeName && !isEnv && !isChatVar && (
                                <div className="flex items-center">
                                  <div className="hidden h-3 px-[1px]">
                                    {outputVarNode?.type && (
                                      <VarBlockIcon
                                  ...
                                  <div
                                    className="mx-0.5 truncate text-xs font-medium text-[#0F172A]"
                ...
                {hasValue && !readonly && !isInTable && (
                  <div
                    className="group invisible absolute right-1 top-[50%] h-5 translate-y-[-50%] cursor-pointer rounded-full p-1 hover:bg-black/5 group-hover/wrap:visible"
