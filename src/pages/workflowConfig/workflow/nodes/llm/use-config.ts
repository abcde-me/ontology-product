...
import { useModelListAndDefaultModelAndCurrentProviderAndModel } from '@/pages/workflowConfig/hooks/use-model'
import {
  ModelTypeEnum,
...
import { RETRIEVAL_OUTPUT_STRUCT } from '@/pages/workflowConfig/workflow/constants'
import { checkHasContextBlock, checkHasHistoryBlock, checkHasQueryBlock } from '@/pages/workflowConfig/components/prompt-editor/constants'
...
const useConfig = (id: string, payload: LLMNodeType) => {
  ...
  useEffect(() => {
    inputRef.current.desc = payload.desc
  }, [payload.desc])
