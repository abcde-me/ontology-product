...
import { addDefaultValue, toolParametersToFormSchemas } from '@/pages/workflowConfig/tools/utils/to-form-schema'
...
import { VarType as VarVarType } from '@/pages/workflowConfig/workflow/types'
import type { InputVar, ValueSelector, Var } from '@/pages/workflowConfig/workflow/types'
...
const useConfig = (id: string, payload: ToolNodeType) => {
  ...
  */
  ...
  const handleSaveAuth = useCallback(async (value: any) => {
    ...
    console.warn('API NOT IMPLEMENTED', 'updateBuiltInToolCredential')
