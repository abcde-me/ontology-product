...
import type { Item } from '@/pages/workflowConfig/components/select';
    ...
    return (
      <div className="flex h-6 items-center justify-between">
        <div className="flex h-full items-center">
          <RiBracesLine className="mr-[5px] h-3.5 w-3.5 text-text-accent" />
  ...
  return (
    <div className={cn(className)}>
      <Select
        ...
        className="!text-[13px]"
        placeholder={t(
          'workflow.nodes.listFilter.selectVariableKeyPlaceholder'
        )}
            ...
            {item ? (
              <div className="flex cursor-pointer justify-start">
                <div className="inline-flex h-6 max-w-full items-center rounded-md border-[0.5px] border-components-panel-border-subtle bg-components-badge-white-to-dark px-1.5 text-text-accent shadow-xs">
                  <RiBracesLine className="h-3.5 w-3.5 shrink-0 text-text-accent" />
                  <div className="system-xs-medium ml-0.5 truncate">
                    {item?.name}
                  </div>
                </div>
              </div>
              ...
              <div className="system-sm-regular flex pl-1 text-components-input-text-placeholder  group-hover/sub-variable-picker:text-text-tertiary">
                <RiBracesLine className="mr-1 h-4 w-4 shrink-0" />
