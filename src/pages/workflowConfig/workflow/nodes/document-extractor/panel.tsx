...
import { BlockEnum, InputVarType, type NodePanelProps } from '@/pages/workflowConfig/workflow/types'
...
import fileSupportJson from '@/pages/workflowConfig/mockData/filesSupportType.json'
...
const Panel: FC<NodePanelProps<DocExtractorNodeType>> = ({
  ...
  console.warn('API NOT IMPLEMENTED', 'fetchSupportFileTypes')
  const supportFileTypesResponse = fileSupportJson as any
