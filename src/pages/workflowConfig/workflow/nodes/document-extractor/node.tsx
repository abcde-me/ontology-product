...
import { BlockEnum, type Node, type NodeProps } from '@/pages/workflowConfig/workflow/types'
...
const NodeComponent: FC<NodeProps<DocExtractorNodeType>> = ({
  ...
  return (
    <div className='relative px-3'>
      <div className='my-1 system-2xs-medium-uppercase text-text-tertiary'>{t(`${i18nPrefix}.inputVar`)}</div>
      <NodeVariableItem
        node={node as Node}
        isEnv={isEnv}
        isChatVar={isChatVar}
