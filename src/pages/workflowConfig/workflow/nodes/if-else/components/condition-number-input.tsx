...
import { variableTransformer } from '@/pages/workflowConfig/workflow/utils'
      ...
      <div className='grow w-0 ml-0.5'>
        {
          numberVarType === NumberVarType.variable && (
            ...
            >
                ...
                }
                {
                  !value && (
                    <div className='flex items-center p-1 h-6 text-components-input-text-placeholder text-[13px]'>
                      <RiBracesLine className='shrink-0 mr-1 w-4 h-4' />
              ...
              <PortalToFollowElemContent className='z-[1000]'>
                <div className={cn('w-[296px] pt-1 bg-components-panel-bg-blur rounded-[4px] border-[0.5px] border-components-panel-border shadow-lg', isShort && 'w-[200px]')}>
                  <VarReferenceVars
                    vars={variables}
