...
import type { NodeProps, Variable } from '@/pages/workflowConfig/workflow/types'
    ...
    <div className={`wk-node-content`}>
      <div className={`output-section ${!show ? 'collapsed' : ''}`}>
        ...
        <div className='output-list'>
          ...
          {!filteredOutputs.length && <div className='output-var-item'><span className='extra-info'>未配置变量</span></div>}
        </div>
      </div>
    </div>
  )
