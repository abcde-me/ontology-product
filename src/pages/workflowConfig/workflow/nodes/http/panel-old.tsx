...
import { RiSettings2Line, RiArrowGoForwardLine } from '@remixicon/react'
          ...
          operations={
            <div className='flex'>
              <div
                ...
                className={cn(!readOnly && 'cursor-pointer hover:bg-gray-50', 'flex items-center h-6 space-x-1 px-2 rounded-[4px] ')}
              >
                {!readOnly && <RiSettings2Line className='w-3 h-3 text-gray-500' />}
              ...
              <div
                ...
                className={cn(!readOnly && 'cursor-pointer hover:bg-gray-50', 'flex items-center h-6 space-x-1 px-2 rounded-[4px] ')}
              >
                {!readOnly && <RiArrowGoForwardLine className='w-3 h-3 text-gray-500' />}
                <div className='text-xs font-medium text-gray-500'>
