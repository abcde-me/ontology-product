  ...
  return (
    ...
    >
      <div>
        <textarea
          value={inputString}
          className='w-full my-3 p-3 text-sm text-gray-900 border-0 rounded-[4px] grow bg-gray-100 focus:outline-none focus:ring-1 focus:ring-inset focus:ring-gray-200 h-40'
