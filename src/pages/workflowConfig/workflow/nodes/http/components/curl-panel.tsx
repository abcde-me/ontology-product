  ...
  return (
    ...
    >
      <div>
        <textarea
          value={inputString}
          className="my-3 h-40 w-full grow rounded-[4px] border-0 bg-gray-100 p-3 text-sm text-gray-900 focus:outline-none focus:ring-1 focus:ring-inset focus:ring-gray-200"
