...
import BaseInput from '@/pages/workflowConfig/components/input'
              ...
              <Field title={t(`${i18nPrefix}.api-key-title`)} isRequired>
                <div className='flex'>
                  <Input
                    ...
                    className={cn(isFocus ? 'shadow-xs bg-gray-50 border-gray-300' : 'bg-gray-100 border-gray-100', 'w-0 rounded-[4px] grow px-3 py-[6px] border')}
