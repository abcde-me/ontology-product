  ...
  return (
    ...
    >
      <PortalToFollowElemTrigger asChild>
        <div className={`
          zoom-in-out-tools h-[32px] cursor-pointer text-[13px] backdrop-blur-[5px] rounded-[4px]
          bg-components-actionbar-bg border-[0.5px] border-components-actionbar-border 
          ${workflowReadOnly && '!cursor-not-allowed opacity-50'}
        `}>
          <div className={cn(
            'flex items-center justify-between w-[98px] h-8 rounded-[4px]',
          )}>
            <TipPopup
            ...
            >
              <div
                className={`flex items-center justify-center w-8 h-8 rounded-[4px] ${zoom <= 0.25 ? 'cursor-not-allowed' : 'cursor-pointer hover:bg-black/5'}`}
                onClick={(e) => {
                  if (zoom <= 0.25)
                    return
            ...
            >
              <div
                className={`flex items-center justify-center w-8 h-8 rounded-[4px] ${zoom >= 2 ? 'cursor-not-allowed' : 'cursor-pointer hover:bg-black/5'}`}
                onClick={(e) => {
                  if (zoom >= 2)
                    return
      ...
      <PortalToFollowElemContent className='z-10'>
        <div className='w-[145px] backdrop-blur-[5px] rounded-[4px] border-[0.5px] border-components-panel-border bg-components-panel-bg-blur shadow-lg'>
          {
