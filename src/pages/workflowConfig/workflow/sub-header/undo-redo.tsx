...
import RedoIcon from '@/pages/workflowConfig/styles/images/op-icons/redo.svg';
import UndoIcon from '@/pages/workflowConfig/styles/images/op-icons/undo.svg';
    ...
    <div className='flex items-center gap-x-[4px]'>
      ...
      >
        <div
          ...
          className={
            classNames('op-icon select-none',
              (nodesReadOnly || buttonsDisabled.undo)
              && 'disabled hover:bg-transparent text-text-disabled hover:text-text-disabled cursor-not-allowed')}
