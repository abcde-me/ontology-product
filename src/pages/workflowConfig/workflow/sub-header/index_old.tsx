...
const Header: FC = () => {
  ...
  const publishWorkflow = (args: any) => {
    return {} as any;
  };
  ...
  return (
    <div className="app-workflow-page-sub-header absolute left-0 top-0 z-10 flex h-14 w-full items-center justify-between bg-mask-top2bottom-gray-50-to-transparent px-3">
