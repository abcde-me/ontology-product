      ...
      <PortalToFollowElemTrigger asChild>
        ...
        `}>
          <div className={cn(
            ...
            >
              <div
                className={`op-icon ${zoom >= 2 ? 'cursor-not-allowed' : 'cursor-pointer'}`}
                onClick={(e) => {
                  if (zoom >= 2)
                    return
