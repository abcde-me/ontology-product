  ...
  return (
    ...
    >
      <PortalToFollowElemTrigger asChild>
        <div
          className={`
          zoom-in-out-tools cursor-pointer border-[0px]
          border-components-actionbar-border bg-components-actionbar-bg backdrop-blur-[5px] 
      ...
      <PortalToFollowElemContent className="z-10">
        <div className="w-[145px] rounded-[4px] border-[0.5px] border-components-panel-border bg-components-panel-bg-blur shadow-lg backdrop-blur-[5px]">
