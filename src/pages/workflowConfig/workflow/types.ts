...
import type { Resolution, TransferMethod } from '@/pages/workflowConfig/types/app'
...
import type { FileResponse, NodeTracing } from '@/pages/workflowConfig/types/workflow'
