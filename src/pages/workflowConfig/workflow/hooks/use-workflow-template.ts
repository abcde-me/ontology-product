...
export const useWorkflowTemplate = () => {
  ...
  if (isChatMode) {
    ...
    return {
      nodes: [startNode, textNode, picNode, audioNode, videoNode, cleaningNode, enhancementNode, endNode],
      edges: [
        startToTextEdge, startToPicEdge, startToAudioEdge, startToVideoEdge,
        textToCleaningEdge, picToCleaningEdge, audioToCleaningEdge, videoToCleaningEdge,
        cleaningToEnhancementEdge, enhancementToEndEdge
      ],
    }
  }
}
