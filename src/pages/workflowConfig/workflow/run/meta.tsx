...
const MetaData: FC<Props> = ({
  ...
  return (
    <div className='relative workflow-log-metadata'>
      <div className='h-6 py-1 text-text-tertiary system-xs-medium-uppercase font-semibold'>{t('runLog.meta.title')}</div>
      <div className='py-1'>
        <div className='flex'>
