...
import formatNodeList from '@/pages/workflowConfig/workflow/run/utils/format-log';
...
const TracingPanel: FC<TracingPanelProps> = ({
          ...
          <div className="mb-1 flex items-center">
            <button
              ...
              className={cn(
                ...
                isHovered
                  ? 'rounded border-components-button-primary-border bg-components-button-primary-bg text-text-primary-on-surface'
            ...
            >
              {isHovered ? (
                ...
                <RiMenu4Line className="h-3 w-3 text-text-tertiary" />
              )}
            </button>
  ...
  return (
    <div
      className={cn('pb-[16px]', className)}
      onClick={(e) => {
        e.stopPropagation();
