...
const CustomEdge = ({
  ...
  const stroke = useMemo(() => {
    ...
    if (data?._connectedNodeIsHovering || data?._connectedNodeIsSelected)
      return getEdgeColor(
    ...
    <>
      ...
      <BaseEdge
        ...
        style={{
          ...
          strokeDasharray: linearGradientId ? '20, 10' : 'none',
          animation: linearGradientId
            ? 'wk-line-move 5s infinite linear'
            : 'none'
        }}
      />
      <EdgeLabelRenderer>
