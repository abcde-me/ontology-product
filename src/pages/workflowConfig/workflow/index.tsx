  ...
  ({ nodes: originalNodes, edges: originalEdges, viewport }) => {
    ...
    return (
      <div
        ...
        className={`
        workflow-container relative h-full w-full min-w-[960px]
      ...
      >
        ...
        <ReactFlow
          ...
          onNodeClick={!isShowChatMode ? handleNodeClick : undefined}
...
const WorkflowWrap = memo(() => {
  ...
  const fileUploadConfigResponse = fileUploadConfigJson as any;
