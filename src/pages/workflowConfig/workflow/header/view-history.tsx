...
const ViewHistory = ({
  ...
  console.warn('API NOT IMPLEMENTED', 'fetchChatRunHistory', 'fetchWorkflowRunHistory')
          ...
          }
          {
            !withText && (
              ...
              >
                ...
                >
                  <RiPlayCircleLine className={cn('w-4 h-4 group-hover:text-components-button-secondary-accent-text', open ? 'text-components-button-secondary-accent-text' : 'text-components-button-ghost-text')} />
                </div>
              </Tooltip>
            )
          }
                ...
                <div className='p-2'>
                  {
                    !data?.data.length && (
                      <div className='py-12'>
                        <RiPauseCircleLine className='mx-auto mb-2 w-8 h-8 text-gray-300' />
                      ...
                      >
                        {
                          !isChatMode && item.status === WorkflowRunningStatus.Stopped && (
                            <RiAlertLine className='mt-0.5 mr-1.5 w-3.5 h-3.5 text-[#F79009]' />
                          )
                        }
                        {
