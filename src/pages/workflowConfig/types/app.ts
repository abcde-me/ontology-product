import type { AnnotationReplyConfig, ChatPromptConfig, CompletionPromptConfig, DatasetConfigs, PromptMode } from '@/pages/workflowConfig/models/debug'
// import type { CollectionType } from '@/app/components/tools/types'
import type { LanguagesSupported } from '@/pages/workflowConfig/i18n/language'
// import type { Tag } from '@/app/components/base/tag-management/constant'
import type {
  RerankingModeEnum,
  WeightedScoreEnum,
} from '@/pages/workflowConfig/models/datasets'
import type { UploadFileSetting } from '@/pages/workflowConfig/workflow/types'
...
export type AgentTool = {
  provider_id: string
  provider_type: any // CollectionType
