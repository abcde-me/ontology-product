...
const WorkflowToolAsModal: FC<Props> = ({
  ...
  const onConfirm = () => {
    ...
    if (!name)
      errorMessage = t('common.errorMsg.fieldRequired', {
        field: t('tools.createTool.nameForToolCall')
      });
          ...
          <div className="flex h-full flex-col">
            <div className="h-0 grow space-y-4 overflow-y-auto px-6 py-3">
              ...
              <div>
                ...
                <div className="tool-icon flex items-center justify-between gap-3">
                  <AppIcon
                    size="large"
                    onClick={() => {
                  ...
                  />
                  <Input
                    className="h-10 grow rounded-[4px]"
              ...
              <div>
                ...
                <div className="w-full overflow-x-auto rounded-[4px] border border-divider-regular">
