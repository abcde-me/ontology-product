...
import MethodSelector from '@/pages/workflowConfig/tools/workflow-tool/method-selector'
import ConfirmModal from '@/pages/workflowConfig/tools/workflow-tool/confirm-modal'
  ...
  return (
    <>
      <Drawer
        ...
        panelClassName='mt-[126px] !mr-[20px] mb[20px] !w-[640px] rounded-[none]'
          ...
          <div className='flex flex-col h-full'>
            <div className='grow h-0 overflow-y-auto px-6 py-3 space-y-4'>
              ...
              <div>
                ...
                <div className='flex items-center justify-between gap-3 tool-icon'>
                  <AppIcon size='large' onClick={() => { setShowEmojiPicker(false) }} className='cursor-pointer' iconType='emoji' icon={emoji.content} background={emoji.background} />
                  <Input
                    className='grow h-10 rounded-[4px]'
              ...
              <div>
                <div className='flex items-center py-2 system-sm-medium text-text-primary'>
                  <span className='mr-1 text-red-500'>*</span> {t('tools.createTool.nameForToolCall')}
                  <Tooltip
                    popupContent={
              ...
              <div>
                ...
                <div className='rounded-[4px] border border-divider-regular w-full overflow-x-auto'>
            ...
            <div className={cn((!isAdd && onRemove) ? 'justify-between' : 'justify-end', 'mt-2 shrink-0 flex py-4 px-6 rounded-b-[10px] bg-background-section-burn border-t border-divider-regular')} >
              ...
              <div className='flex space-x-2 '>
                ...
                <Button variant='primary' className="custom-primary" onClick={() => {
                  if (isAdd)
                    onConfirm()
                  else
                    setShowModal(true)
