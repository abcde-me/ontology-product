...
import type { Emoji, WorkflowToolProviderParameter, WorkflowToolProviderRequest, WorkflowToolProviderResponse } from '@/pages/workflowConfig/tools/types'
...
const WorkflowToolConfigureButton = ({
  ...
  return (
    <>
      ...
      {(!published || !isLoading) && (
        <div className={cn(
          'group bg-background-section-burn rounded-[4px] transition-colors',
          ...
          {isCurrentWorkspaceManager
            ? (
              ...
              >
                ...
                {!published && (
                  <span className='shrink-0 px-1 py-0.5 system-2xs-medium-uppercase text-text-tertiary'>
