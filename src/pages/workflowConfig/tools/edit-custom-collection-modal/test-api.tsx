...
import { AuthType, type Credential, type CustomCollectionBackend, type CustomParamSchema } from '@/pages/workflowConfig/tools/types'
...
import { getLanguage } from '@/pages/workflowConfig/i18n/language'
...
const TestApi: FC<Props> = ({
  ...
  const handleTest = async () => {
    ...
    console.warn('API NOT IMPLEMENTED', 'testAPIAvailable')
    const res = { error: '', result : 'ok' }
  ...
  return (
    <>
      <Drawer
        ...
        panelClassName='mt-[50px] !mr-0 mb-0 rounded-none !w-[600px]'
        ...
        body={
          <div className='pt-2 px-6 overflow-y-auto'>
            ...
            <Button variant='primary' className='custom-primary mt-4 w-full h-10' onClick={handleTest}>{t('tools.test.title')}</Button>
            <div className='mt-6'>
