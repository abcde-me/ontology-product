  ...
  return (
    <>
      <Modal
        ...
        onClose={onHide}
        closable
        className={`!p-0 !max-w-[630px] !h-[calc(100vh-16px)] ${className ?? ''}`}
      >
          ...
          <div className='grow h-0 overflow-y-auto px-6 py-3 space-y-4'>
            <div>
              ...
              <div className='flex items-center justify-between gap-3 tool-icon'>
                <AppIcon size='large' onClick={() => { setShowEmojiPicker(false) }} className='cursor-pointer' icon={emoji.content} background={emoji.background} />
                <Input
