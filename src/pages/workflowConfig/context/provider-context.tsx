...
import { ModelTypeEnum, type Model, type ModelProvider } from '@/pages/workflowConfig/models/model'
import type { RETRIEVE_METHOD } from '@/pages/workflowConfig/types/app'
import { Plan, type UsagePlanInfo } from '@/pages/workflowConfig/models/billing'
...
export const ProviderContextProvider = ({
  ...
  return (
    <ProviderContext.Provider value={{
      ...
      isAPIKeySet: true,
      supportRetrievalMethods: ["semantic_search", "full_text_search", "hybrid_search"] as any,
      plan,
      isFetchedPlan,
      enableBilling,
      onPlanInfoChanged: () => {},
