...
import CopyIcon from '@/pages/workflowConfig/components/copy-icon'
import SVGBtn from '@/pages/workflowConfig/components/svg'
import Flowchart from '@/pages/workflowConfig/components/mermaid'
import ImageGallery from '@/pages/workflowConfig/components/image-gallery'
import { useChatContext } from '@/pages/workflowConfig/chat/chat/context'
import VideoGallery from '@/pages/workflowConfig/components/video-gallery'
import AudioGallery from '@/pages/workflowConfig/components/audio-gallery'
import SVGRenderer from '@/pages/workflowConfig/components/svg-gallery'
import MarkdownButton from '@/pages/workflowConfig/components/markdown-blocks/button'
import MarkdownForm from '@/pages/workflowConfig/components/markdown-blocks/form'
import ThinkBlock from '@/pages/workflowConfig/components/markdown-blocks/think-block'
  ...
  if (children_node && children_node[0] && 'tagName' in children_node[0] && children_node[0].tagName === 'img') {
    return (
      <>
        ...
        {
          Array.isArray(paragraph.children) ? <p className='md-p-text'>{paragraph.children.slice(1)}</p> : null
        }
      </>
    )
  }
  return <p className='md-p-text'>{paragraph.children}</p>
}
