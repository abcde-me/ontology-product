...
import ContextBlockReplacementBlock from './plugins/context-block/context-block-replacement-block'
import { QueryBlock } from './plugins/query-block'
import { QueryBlockNode } from './plugins/query-block/node'
import QueryBlockReplacementBlock from './plugins/query-block/query-block-replacement-block'
import { HistoryBlock } from './plugins/history-block'
import { HistoryBlockNode } from './plugins/history-block/node'
import HistoryBlockReplacementBlock from './plugins/history-block/history-block-replacement-block'
...
import WorkflowVariableBlockReplacementBlock from './plugins/workflow-variable-block/workflow-variable-block-replacement-block'
