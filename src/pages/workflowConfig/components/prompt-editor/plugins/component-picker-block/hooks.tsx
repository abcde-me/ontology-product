...
import { RiFileTextLine, RiArrowRightUpLine, RiUserSettingsLine, RiBracesLine, RiChat3Line, RiToolsLine } from '@remixicon/react'
    ...
    promptOptions.push(new PickerBlockMenuOption({
      ...
      render: ({ isSelected, onSelect, onSetHighlight }) => {
        return <PromptMenuItem
          ...
          icon={<RiFileTextLine className='w-4 h-4 text-[#6938EF]' />}
        ...
        render: ({ isSelected, onSelect, onSetHighlight }) => {
          return (
            <PromptMenuItem
              ...
              icon={<RiUserSettingsLine className='w-4 h-4 text-[#FD853A]' />}
        ...
        render: ({ isSelected, onSelect, onSetHighlight }) => {
          return (
            <PromptMenuItem
              ...
              icon={<RiChat3Line className='w-4 h-4 text-[#DD2590]' />}
      ...
      return new PickerBlockMenuOption({
        ...
        render: ({ queryString, isSelected, onSelect, onSetHighlight }) => {
          return (
            <VariableMenuItem
              title={item.value}
              icon={<RiBracesLine className='w-[14px] h-[14px] text-text-accent' />}
      ...
      render: ({ queryString, isSelected, onSelect, onSetHighlight }) => {
        return (
          <VariableMenuItem
            ...
            icon={<RiToolsLine className='w-[14px] h-[14px] text-text-accent' />}
            extraElement={<RiArrowRightUpLine className='w-3 h-3 text-text-tertiary' />}
            queryString={queryString}
            isSelected={isSelected}
            onClick={onSelect}
            onMouseEnter={onSetHighlight}
