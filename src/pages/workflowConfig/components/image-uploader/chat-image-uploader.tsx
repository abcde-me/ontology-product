...
import { RiImageAddLine, RiUploadCloudLine } from '@remixicon/react'
...
import type { ImageFile, VisionSettings } from '@/pages/workflowConfig/types/app'
    ...
    <Uploader onUpload={onUpload} disabled={disabled} limit={limit}>
      {hovering => (
        <div
          ...
          `}
        >
          <RiImageAddLine className="w-4 h-4 text-gray-500" />
        </div>
      )}
    </Uploader>
  )
            ...
            <>
              ...
              >
                {hovering => (
                  ...
                  >
                    <RiUploadCloudLine className="mr-1 w-4 h-4" />
