...
export default class AudioPlayer {
  ...
  constructor(
    ...
    this.audio.src = this.mediaSource
      ? URL.createObjectURL(this.mediaSource)
      : '';
  ...
  private async loadAudio() {
    try {
      console.warn('API NOT IMPLEMENTED', 'textToAudioStream');
  ...
  public playAudioWithAudio(audio: string, play = true) {
