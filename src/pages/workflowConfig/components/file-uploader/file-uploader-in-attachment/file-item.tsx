...
const FileInAttachmentItem = ({
  ...
  return (
    <>
      <div className={cn(
        'flex items-center pr-3 h-12 rounded-[4px] border-[0.5px] border-components-panel-border bg-components-panel-on-panel-item-bg shadow-xs',
        ...
        <div className='shrink-0 flex items-center'>
          ...
          }
          {
            progress === -1 && (
              ...
              >
                <RiReplay5Line className='w-4 h-4 text-text-tertiary' />
              </ActionButton>
            )
          }
          {
            showDeleteAction && (
              <ActionButton styleCss={{ borderRadius: '4px'}} onClick={() => onRemove?.(id)}>
