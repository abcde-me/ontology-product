...
import ActionButton, { ActionButtonState } from '@/pages/workflowConfig/components/action-button'
  ...
  return (
    <>
      <div className={cn('relative', !isTop && 'mt-3', className)}>
        {isLoading && (
          <div className={cn('flex items-center h-10', !inSidePanel && '')}><Loading type='area' /></div>
        )}
        {!isLoading && (
          <>
            {/* result content */}
                  ...
                  <div className={cn(
                    ...
                    {taskId && (
                      <div className={cn('mb-2 flex items-center system-2xs-medium-uppercase text-text-accent-secondary', isError && 'text-text-destructive')}>
                        <RiArrowRightBoxFill className='w-3 h-3 mr-1' />
                    ...
                    {showResultTabs && (
                      <div className='result-tabs flex items-center px-1 space-x-6'>
                        <div
                          className={cn(
            ...
            <div className={cn(
              ...
              {/* action buttons */}
              <div className='absolute right-2 bottom-1 flex items-center action-btns'>
                ...
                <div className='ml-1 flex items-center gap-0.5 p-0.5 rounded-[10px] border-[0.5px] border-components-actionbar-border bg-components-actionbar-bg shadow-md backdrop-blur-sm'>
                  ...
                  {((currentTab === 'RESULT' && workflowProcessData?.resultText) || !isWorkflow) && (
                    <ActionButton className="result-action-btn copy" disabled={isError || !messageId} onClick={() => {
