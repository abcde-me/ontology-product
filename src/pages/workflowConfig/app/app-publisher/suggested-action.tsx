...
const SuggestedAction = ({ icon, link, disabled, children, className, ...props }: SuggestedActionProps) => (
  <a
    ...
    className={classNames(
      'flex justify-start items-center gap-2 py-2 px-2.5 bg-background-section-burn rounded-[4px] transition-colors [&:not(:first-child)]:mt-1',
    ...
    {...props}
  >
    {icon && <div className='relative w-4 h-4'>{icon}</div>}
