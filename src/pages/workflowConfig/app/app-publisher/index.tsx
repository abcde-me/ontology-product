    ...
    <>
      ...
      >
        ...
        <PortalToFollowElemContent className='z-[11]'>
          <div className='w-[320px] bg-components-panel-bg rounded-[4px] border-[0.5px] border-components-panel-border shadow-xl shadow-shadow-shadow-5'>
            <div className='p-4 pt-3'>
              <div className='flex items-center justify-between h-6 system-xs-medium-uppercase text-text-tertiary'>
                <span>{publishedAt ? t('workflow.common.latestPublished') : t('workflow.common.currentDraftUnpublished')}</span>
                {publishedAt
                  ? (
            ...
            <div className='hidden p-4 pt-3 border-t-[0.5px] border-t-divider-regular'>
              <SuggestedAction
