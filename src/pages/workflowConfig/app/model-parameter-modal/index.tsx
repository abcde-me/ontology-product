...
import { ModelStatusEnum } from '@/pages/workflowConfig/models/model'
...
import { TONE_LIST } from '@/pages/workflowConfig/config/'
import { RiArrowLeftLine } from '@remixicon/react'
import modelsParameterRules from '@/pages/workflowConfig/mockData/modelsParameterRules.json'
...
const ModelParameterModal: FC<ModelParameterModalProps> = ({
  ...
  console.warn('API NOT IMPLEMENTED', 'fetchModelParameterRules')
  const parameterRulesData = modelsParameterRules
  ...
  const parameterRules: ModelParameterRule[] = useMemo(() => {
    return (parameterRulesData?.data || []) as any[]
  }, [parameterRulesData])
    ...
    >
      <div className='relative'>
        ...
        <PortalToFollowElemContent className={cn('z-[60]', portalToFollowElemContentClassName)}>
          <div className={cn(popupClassName, 'w-[389px] rounded-[4px] border-[0.5px] border-components-panel-border bg-components-panel-bg shadow-lg')}>
            <div className={cn('max-h-[420px] p-4 pt-3 overflow-y-auto')}>
              <div className='relative'>
                ...
                <ModelSelector
                  ...
                  triggerClassName="rounded-[6px] border-[#CBD5E1] bg-[white] border-[1px]"
            ...
            {!hideDebugWithMultipleModel && (
              ...
              >
                ...
                <RiArrowLeftLine className='w-3 h-3 rotate-180' />
              </div>
            )}
          </div>
        </PortalToFollowElemContent>
