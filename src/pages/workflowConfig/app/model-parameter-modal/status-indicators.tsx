...
import { SwitchPluginVersion } from '@/pages/workflowConfig/workflow/nodes/_base/components/switch-plugin-version'
...
const StatusIndicators = ({ needsConfiguration, modelProvider, inModelList, disabled, pluginInfo, t }: StatusIndicatorsProps) => {
  console.warn('API NOT IMPLEMENTED', 'useInstalledPluginList')
