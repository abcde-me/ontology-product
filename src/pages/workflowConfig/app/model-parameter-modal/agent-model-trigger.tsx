...
import { InstallPluginButton } from '@/pages/workflowConfig/workflow/nodes/_base/components/install-plugin-button'
...
const AgentModelTrigger: FC<AgentModelTriggerProps> = ({
  ...
  console.warn('API NOT IMPLEMENTED', 'useModelInList', 'usePluginInfo')
  const inModelList = false
  const pluginInfo = {} as any
  const isPluginLoading = false
