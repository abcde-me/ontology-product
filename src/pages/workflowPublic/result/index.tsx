...
import { sendCompletionMessage, sendWorkflowMessage } from '@/pages/workflowConfig/service/share'
...
import { TransferMethod, type VisionFile, type VisionSettings } from '@/pages/workflowConfig/types/app'
import { NodeRunningStatus, WorkflowRunningStatus } from '@/pages/workflowConfig/workflow/types'
...
import { TEXT_GENERATION_TIMEOUT_MS } from '@/pages/workflowConfig/config'
import {
  getFilesInLogs,
} from '@/pages/workflowConfig/components/file-uploader/utils'
...
const Result: FC<IResultProps> = ({
  ...
  const renderTextGenerationRes = () => (<>
    <TextGenerationRes
      ...
      siteInfo={siteInfo}
    />
    {isCallBatchAPI && <div className='batch-item-sepatator w-full mb-[16px] border-b-[0.5px] border-divider-regular'/>}
    </>
  )
