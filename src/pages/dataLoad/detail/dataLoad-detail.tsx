import { Breadcrumb, Grid, Modal, Pagination, Switch } from '@arco-design/web-react'
        ...
        <div style={{
            ...
            <div className="info-container">
                <div className="info-column">
                    <Row style={{ marginBottom: 16, display: 'flex', alignItems: 'center' }}>
                        <Col span={3} style={{ fontWeight: 'bold', fontSize: '15px' }}>载入位置：</Col>
                        <Col span={21}>
                            {listDetail.task_info.dest_path}
                        </Col>
                    </Row>
                    <Row style={{ marginBottom: 16, display: 'flex', alignItems: 'center' }}>
                        <Col span={3} style={{ fontWeight: 'bold', fontSize: '15px' }}>创建人：</Col>
                        <Col span={21}>
                            {listDetail.task_info.creator}
                        </Col>
                    </Row>
                    <Row style={{ marginBottom: 16, display: 'flex', alignItems: 'center' }}>
                        <Col span={3} style={{ fontWeight: 'bold', fontSize: '15px' }}>创建时间：</Col>
                        <Col span={21}>
                            {listDetail.task_info.created_at}
                        </Col>
                    </Row>
                    <Row style={{ marginBottom: 16, display: 'flex', alignItems: 'center' }}>
                        <Col span={3} style={{ fontWeight: 'bold', fontSize: '15px' }}>更新时间：</Col>
                        <Col span={21}>
                ...
                <div className="info-column">
                    <Row style={{ marginBottom: 16, display: 'flex', alignItems: 'center' }}>
                        <Col span={4} style={{ fontWeight: 'bold', fontSize: '15px' }}>数据源类型：</Col>
                        <Col span={20}>
                            {listDetail.task_info.source_type}
                        </Col>
                    </Row>
                    <Row style={{ marginBottom: 16, display: 'flex', alignItems: 'center' }}>
                        <Col span={4} style={{ fontWeight: 'bold', fontSize: '15px' }}>连接器名称：</Col>
                        <Col span={20}>
                            {listDetail.task_info.connector.name}
                        </Col>
                    </Row>
                    <Row style={{ marginBottom: 16, display: 'flex', alignItems: 'center' }}>
                        <Col span={4} style={{ fontWeight: 'bold', fontSize: '15px' }}>载入形式：</Col>
                        <Col span={20}>
                            {listDetail.task_info.load_type == 'once' ? '单次载入' : '周期载入'}
                            {listDetail.task_info.load_type == 'cron' &&
                                <Switch checkedText='启用' uncheckedText='停止' style={{ marginLeft: '10px' }}
                    ...
                    </Row>
                    {
                        listDetail.task_info.load_type == 'cron' &&
                        <Row style={{ marginBottom: 16, display: 'flex', alignItems: 'center' }}>
                            <Col span={4} style={{ fontWeight: 'bold', fontSize: '15px' }}>周期设置：</Col>
                            <Col span={20}>
