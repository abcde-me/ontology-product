import { Button, Form, Input, Radio, Select, TreeSelect } from '@arco-design/web-react'
...
const Edit = (props) => {
    ...
    return <div style={{ display: 'flex', flexDirection: 'column' }}>
        <Form style={{ width: '100%' }} autoComplete='off' form={form}>
            ...
            >
                <Select placeholder='请选择连接器' disabled={true}>
            ...
            >
                <RadioGroup onChange={(val) => { handoffLoadFormHan(val) }} disabled={true}>
