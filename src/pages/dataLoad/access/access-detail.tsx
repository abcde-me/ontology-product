import { Breadcrumb, Grid, Input, Modal, Pagination, Switch } from '@arco-design/web-react'
...
const AccessDetail = () => {
    ...
    return <div>
        ...
        <div style={{
            ...
            <div style={{ fontSize: '17px', fontWeight: '600', margin: '15px 0px 0px 17px' }}>任务信息</div>
            <div className='task-box'>
                <div className='task-left'>
                    <Row className={'task-left-item'}>
                        <Col span={4} className={'fontWeight'}>开始时间：</Col>
                        <Col span={20}>1</Col>
                    </Row>
                    <Row className={'task-left-item'}>
                        <Col span={4} className={'fontWeight'}>结束时间：</Col>
                        <Col span={20}>2</Col>
                    </Row>
                    <Row className={'task-left-item'}>
                        <Col span={4} className={'fontWeight'}>运行时长：</Col>
                        <Col span={20}>3</Col>
                    </Row>
                </div>
                <div className='task-right'>
                    <div className='task-right-item' style={{ color: 'black' }}>
                        ...
                        <div className='fontSize'>
                            {filed.fild.toLocaleString()}
                        </div>
                    </div>
                    <div className='task-right-item' style={{ color: 'green' }}>
                        <div>成功</div>
                        <div className='fontSize'>
                            {filed.succeed.toLocaleString()}
                        </div>
                    </div>
                    <div className='task-right-item' style={{ color: 'red' }}>
                        <div>失败</div>
                        <div className='fontSize'>
                            {filed.error.toLocaleString()}
                        </div>
                    </div>
                </div>
            </div>
            <div style={{ fontSize: '17px', fontWeight: '600', margin: '15px 0px 15px 17px' }}>文件详情</div>
            <InputSearch allowClear placeholder='搜索文件名' style={{ width: 200,marginLeft:'17px' }} />
            <AccessTable />
        </div>
    </div>
}
