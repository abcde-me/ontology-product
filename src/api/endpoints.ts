...
export const ModaForgeResourceEndpoints = {
  ...
  // 搜索表
  openDataSearchTableApi: PrefixAimdp + '/OpenDataSearchTable',
  // 获取数据API详情
  openDataGetApiDetailApi: PrefixAimdp + '/OpenDataGetDataAPI',
  // 更新数据API
  ...
  // 取消授权数据API
  openDataRevokeApi: PrefixAimdp + '/OpenDataRevokeApi',
  ...
  // 根据对象类型ID查询行为列表
  ListOntologyActionByObjectTypeApi:
    PrefixAimdp + '/ListOntologyActionByObjectType',
  ...
  // 批量查询执行日志
  BatchGetExecuteTestLogApi: PrefixAimdp + '/BatchGetExecuteTestLog',
  // 停止函数测试
