...
import { TransferMethod } from '@/utils/type';
import type { Annotation } from '@/utils/type';
  ...
  const handleSend = useCallback(
    async (
      ...
      const bodyParams = {
        ...
        conversation_id: connversationId.current || undefined,
        ...data
      };
      ...
      ssePost(
        ...
        },
        {
            ...
            if (
              ...
              const newChatList = produce(chatListRef.current, (draft) => {
                ...
                if (index !== -1) {
                  ...
                  const time: any = new Date(newResponseItem.created_at * 1000);
                  draft[index] = {
                    ...draft[index],
                    more: {
                      time: isNaN(time)
          ...
          getAbortController(controller) {
            sendMessageAbortControllerRef.current = controller;
          }
        }
      );
      return true;
