...
const renderActionColumn = (_, record, setVisible) => (
    <div style={{ display: 'flex', gap: 8 }}>
        <span
            style={{ color: '#165DFF', display: 'inline-block', width: '100%', textAlign: 'center', cursor: 'pointer' }}
 ...
 * 根据表格类型和活动状态生成对应的列配置
 */
export const getUnifiedColumns = (tableType: 'source' | 'target', dataType: 'volume' | 'database', setVisible, hoveredRowId = null) => {
    // Source表格的卷数据列配置
