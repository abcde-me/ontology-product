...
In another console terminal window, run:
...
./bin/bridge  -plugins console-plugin-appforge=http://10.253.56.204(虚机IP或localhost):9001
```
...
#### [not inuse now]Running start-console with Apple silicon and podman
...
### [not inuse now]Option 2: Docker + VSCode Remote Container
